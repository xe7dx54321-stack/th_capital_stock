...
# Probe reporting (with mode)
w('08_scripts/reporting/build_phase121_source_probe.py', '''import json,sys,os
...
# Brief
w('08_scripts/reporting/build_phase121_expansion_brief.py', '''import sys,os
sys.path.insert(0,os.path.join(os.path.dirname(__file__),"..","lib"))
...
# Dashboard
w('08_scripts/reporting/build_phase121_dashboard.py', '''import json,sys,os
...
print('Special reporting files done')