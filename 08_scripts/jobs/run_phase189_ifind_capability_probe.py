...
def run_pipeline(mode="dry-run"):
    ...
    return {"phase189_ifind_capability_probe_pipeline": {
        ...
        "hk_market_available": boundary["phase189_hk_us_boundary"].get("hk_market_data_available", False),
        "hk_note": boundary["phase189_hk_us_boundary"].get("hk_note", "N/A"),
        "us_probed": boundary["phase189_hk_us_boundary"]["us_probe_count"],
        "us_market_available": boundary["phase189_hk_us_boundary"].get("us_market_data_available", False),
        "us_note": boundary["phase189_hk_us_boundary"].get("us_note", "N/A"),
