#!/usr/bin/env python3
"""Run Phase 37 targeted semantic extraction."""
...
def build_payload(conn: sqlite3.Connection, *, ticker: str, limit: int | None = None, task_id: str | None = None, dry_run: bool = True) -> dict:
    return build_targeted_semantic_extraction(conn, ticker, limit=limit, task_id=task_id, dry_run=dry_run)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Phase 37 targeted semantic extraction")
