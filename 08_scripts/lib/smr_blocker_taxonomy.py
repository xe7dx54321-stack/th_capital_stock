...
CODE_ALIASES = {
    ...
    "historical_revenue_missing": "HISTORICAL_REVENUE_MISSING",
    "historical_equity_missing": "HISTORICAL_EQUITY_MISSING",
    ...
    "data_quality_core_gate_passed": "DATA_QUALITY_CORE_GATE",
    "core_evidence_blocker": "CORE_EVIDENCE_BLOCKER",
    "unknown_evidence_dependency": "UNKNOWN_EVIDENCE_DEPENDENCY",
...
BLOCKER_TYPES = {
    ...
    "HISTORICAL_REVENUE_MISSING": "valuation",
    "HISTORICAL_EQUITY_MISSING": "valuation",
    ...
    "PEER_MULTIPLES_MISSING": "valuation",
    "PEER_COUNT_INSUFFICIENT": "valuation",
    "PEER_PARTIAL_DATA": "valuation",
    ...
    "DATA_QUALITY_CORE_GATE": "data_quality",
    "CORE_EVIDENCE_BLOCKER": "evidence",
    "UNKNOWN_EVIDENCE_DEPENDENCY": "evidence",
...
DEFAULT_SEVERITY = {
    ...
    "HISTORICAL_REVENUE_MISSING": "medium",
    "HISTORICAL_EQUITY_MISSING": "medium",
    ...
    "PEER_MULTIPLES_MISSING": "medium",
    "PEER_COUNT_INSUFFICIENT": "medium",
    "PEER_PARTIAL_DATA": "low",
    ...
    "DATA_QUALITY_CORE_GATE": "high",
    "CORE_EVIDENCE_BLOCKER": "high",
    "UNKNOWN_EVIDENCE_DEPENDENCY": "medium",
...
DEFAULT_FIXABILITY = {
    ...
    "DATA_QUALITY_CORE_GATE": "medium",
    "CORE_EVIDENCE_BLOCKER": "medium",
    "UNKNOWN_EVIDENCE_DEPENDENCY": "low",
...
SUGGESTED_FIX = {
    ...
    "HISTORICAL_REVENUE_MISSING": "backfill historical revenue before using PS percentile",
    "HISTORICAL_EQUITY_MISSING": "backfill historical equity before using PB percentile",
    ...
    "PEER_MULTIPLES_MISSING": "derive at least one usable peer multiple from price and fundamentals",
    "PEER_COUNT_INSUFFICIENT": "add enough peers with usable data before using relative valuation strongly",
    "PEER_PARTIAL_DATA": "treat partial peer data as supporting evidence only",
    ...
    "DATA_QUALITY_CORE_GATE": "repair thesis-core data-quality issues before pending review",
    "CORE_EVIDENCE_BLOCKER": "repair missing or blocked thesis-core evidence fields",
    "UNKNOWN_EVIDENCE_DEPENDENCY": "classify the unknown field dependency before promotion",
...
EXPECTED_IMPACT = {
    ...
    "HISTORICAL_REVENUE_MISSING": "may_keep_valuation_supporting_only",
    "HISTORICAL_EQUITY_MISSING": "may_keep_valuation_supporting_only",
    ...
    "PEER_MULTIPLES_MISSING": "may_restore_relative_valuation_context",
    "PEER_COUNT_INSUFFICIENT": "may_keep_valuation_supporting_only",
    "PEER_PARTIAL_DATA": "may_keep_valuation_supporting_only",
    ...
    "DATA_QUALITY_CORE_GATE": "blocks_pending_review_until_core_data_quality_is_repaired",
    "CORE_EVIDENCE_BLOCKER": "blocks_pending_review_until_core_evidence_is_repaired",
    "UNKNOWN_EVIDENCE_DEPENDENCY": "requires_manual_triage",
