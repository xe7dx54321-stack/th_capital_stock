...
def load_config():
    p=Path(__file__).resolve().parent.parent.parent/"config"/"phase87_external_source_integration.json"
...
def get_industry_directions():return load_config()["industry_directions"]
