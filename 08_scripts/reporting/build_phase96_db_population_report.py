...
def build():
    ...
    recs = normalize_hard_data_records(ev['phase96_evidence_loader']['records'])
    recs = recs['phase96_hard_data_normalization']['records']
    return write_hard_data_db(recs, 'dry-run')
