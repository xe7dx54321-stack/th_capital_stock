...
def build():
    ...
    from smr_phase81_threshold_rule_engine import run_threshold_rules
    from smr_phase81_monitoring_evidence_builder import build_monitoring_evidence
    from smr_phase81_monitoring_config import load_config
    s=load_signals()["phase81_signal_loader"]["rows"];b=build_baselines(s);c=load_config();d=detect_delta(b,c);t=run_threshold_rules(d,c);return build_monitoring_evidence(d,t,c)
