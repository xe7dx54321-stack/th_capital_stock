...
def build():
 ...
 from build_phase74_internal_brief import build as build_brief
 br=build_brief();md=br.get("phase74_internal_brief",{}).get("markdown","")
 lt=lint_brief(md)
 lt["has_boss_summary"]="老板摘要" in md
 lt["has_analyst_detail"]="研究员详情" in md
 lt["source_failure_explained"]="卡住" in md
 lt["html_parse_boundary_explained"]="不能做的事" in md
 ...
 return{"phase74_brief_quality_lint":lt}
def main():
