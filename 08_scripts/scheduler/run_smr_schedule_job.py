...
JOB_SPECS: dict[str, JobSpec] = {
    "morning_us": JobSpec(
        ...
        commands=(
            ...
            py("08_scripts/reporting/build_data_freshness_snapshot.py"),
            py("08_scripts/reporting/build_daily_system_health_report.py"),
            py("08_scripts/reporting/build_current_state_snapshot.py"),
            py("08_scripts/agents/run_agent_control_loop.py", "--research-governance-mode", "skip", "--build-dispatch"),
            py("08_scripts/research/build_investment_report_dashboard_snapshot.py", "--limit", "6", "--allow-empty"),
            py("08_scripts/research/build_investment_evidence_gap_tasks.py", "--limit", "6", "--allow-empty"),
            py("08_scripts/research/run_investment_evidence_gap_fetch.py", "--limit", "3", "--execute", "--continue-on-error", "--allow-empty"),
            py("08_scripts/research/build_investment_evidence_pack.py", "--limit", "3"),
        ),
    ),
    ...
    "opportunity_radar": JobSpec(
        ...
        commands=(
            ...
            py(
                "08_scripts/opportunity/build_opportunity_evidence_gap_snapshot.py",
                "--limit",
                "10",
                "--fetch-limit",
                "5",
