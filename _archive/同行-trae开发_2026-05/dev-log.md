...
| 项目 | 状态 | 详情 |
|------|------|------|
| SMR根目录 | ✅ | /Users/apple/Documents/同行资本二级市场部门/二级市场系统/ 35个子目录 |
...
1. 在正常Mac终端运行数据填充：
   ```bash
   python3 /Users/apple/Documents/同行资本二级市场部门/二级市场系统/08_scripts/data_harvester/ah_daily_bar.py --days 30
   ```
